...
const EVENTS = [
  {
    id: 'e1', type: 'tournament',
    title: "Bangkok Cup 2026 — U16 Boys",
    titleTh: "บางกอกคัพ 2026 รุ่น U16 ชาย",
    div: "U16 · Boys",
    loc: "Hua Mark Indoor Stadium",
    city: "Bangkok",
    day: 12, mo: "MAY", date: "May 12–14, 2026",
    status: 'live', statusLabel: 'Live now',
    teams: 16, courts: 3, games: 24, gamesPlayed: 18,
    organizer: "Bangkok Schools Athletic Assoc."
  },
  {
    id: 'e2', type: 'league',
    title: "Bangkok Schools League — Spring",
    titleTh: "ลีกโรงเรียนกรุงเทพฯ ฤดูใบไม้ผลิ",
    div: "U18 · Boys",
    loc: "Multiple courts",
    city: "Bangkok",
    day: 4, mo: "MAY", date: "May 4 – Jul 27, 2026",
    status: 'live', statusLabel: 'Round 6 of 14',
    teams: 12, courts: 6, games: 78, gamesPlayed: 42,
    organizer: "BSL Committee"
  },
  {
    id: 'e3', type: 'showcase',
    title: "Thailand HS Showcase",
    titleTh: "ไทยแลนด์ ไฮสกูล โชว์เคส",
    div: "U18 · Mixed",
    loc: "True Arena Hua Hin",
    city: "Hua Hin",
    day: 20, mo: "JUN", date: "Jun 20–22, 2026",
    status: 'open', statusLabel: 'Registration open',
    teams: 24, courts: 4, games: 0, gamesPlayed: 0,
    organizer: "Thai Basketball Federation"
  },
  {
    id: 'e4', type: 'camp',
    title: "Summer Skills Camp — Shooting",
    titleTh: "แคมป์ทักษะการยิงประตู",
    div: "U12–U15",
    loc: "Patana School",
    city: "Bangkok",
    day: 28, mo: "JUN", date: "Jun 28 – Jul 2, 2026",
    status: 'open', statusLabel: '34/40 spots',
    teams: 0, courts: 1, games: 0, gamesPlayed: 0,
    organizer: "Coach Sukasem"
  },
  {
    id: 'e5', type: 'tournament',
    title: "Chiang Mai Open",
    titleTh: "เชียงใหม่ โอเพ่น",
    div: "U14 · Girls",
    loc: "Chiang Mai University",
    city: "Chiang Mai",
    day: 5, mo: "JUL", date: "Jul 5–7, 2026",
    status: 'upcoming', statusLabel: 'Starts in 67 days',
    teams: 12, courts: 2, games: 22, gamesPlayed: 0,
    organizer: "Northern Schools Athletics"
  },
  {
    id: 'e6', type: 'tournament',
    title: "Phuket Coastal Classic",
    titleTh: "ภูเก็ตโคสตัลคลาสสิก",
    div: "U16 · Boys",
    loc: "Phuket Wittayalai School",
    city: "Phuket",
    day: 26, mo: "JUL", date: "Jul 26–28, 2026",
    status: 'upcoming', statusLabel: 'Reg. opens May 15',
    teams: 16, courts: 2, games: 24, gamesPlayed: 0,
    organizer: "Phuket Schools Sport"
  },
  {
    id: 'e7', type: 'league',
    title: "ASB Junior League",
    titleTh: "เอเอสบี จูเนียร์ลีก",
    div: "U14 · Mixed",
    loc: "ASB Sports Hub",
    city: "Bangkok",
    day: 2, mo: "MAR", date: "Closed Mar 2–Apr 18, 2026",
    status: 'closed', statusLabel: 'Final standings',
    teams: 10, courts: 3, games: 45, gamesPlayed: 45,
    organizer: "ASB"
  }
];

// Bracket for Bangkok Cup (event e1)
const BRACKET = {
  rounds: [
    {
      label: "Round of 16",
...
// Live game (the QF2 from above)
const LIVE_GAME = {
  id: 'q2',
  court: 'COURT B',
  event: 'BANGKOK CUP · QUARTERFINAL 2',
  quarter: 'Q3', clock: '06:42',
  ...
  quarters: {
    a: [14, 18, 22, null], total: 54,
    b: [12, 21, 16, null], total: 49,
  },
  watching: 412,
  pbp: [
...
window.REMY = { TEAMS, EVENTS, BRACKET, LIVE_GAME, ROSTER, STANDINGS, FEED };
