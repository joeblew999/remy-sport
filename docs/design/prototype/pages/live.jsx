// claude-design: app/pages/live.jsx
const { Icon: Ico_live } = window.RemyShell;
  ...
  return (
    <div className="live-page">
      ...
      <div className="spoiler-bar">
        <span><Ico_live name={spoiler ? 'eyeoff' : 'eye'}/> &nbsp; {spoiler ? 'SPOILER MODE ON · scores hidden' : 'SHOWING LIVE SCORES'}</span>
      ...
      <div className="live-header">
        ...
        <div className="row-flex" style={{ gap: 12 }}>
          <span style={{ fontFamily: 'IBM Plex Mono, monospace', fontSize: 11, color: 'oklch(0.7 0.01 270)', letterSpacing: '0.06em' }}>
            <Ico_live name="eye"/> &nbsp; {G.watching} watching
          </span>
...
window.RemyPages = Object.assign(window.RemyPages || {}, { LivePage });
