// claude-design: app/pages/team.jsx
const { Icon: Ico_team } = window.RemyShell;

function TeamPage({ goto, lang }) {
  const roster = window.RemyData.useRoster();
  return (
    <>
      <div className="team-hero">
        ...
        <div>
          ...
          <div className="event-actions" style={{ marginTop: 16 }}>
            <button className="btn primary"><Ico_team name="follow"/>Following</button>
...
window.RemyPages = Object.assign(window.RemyPages || {}, { TeamPage });
