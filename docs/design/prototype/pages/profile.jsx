// claude-design: app/pages/profile.jsx

function ProfilePage({ goto }) {
  const events = window.RemyData.useEvents({ limit: 4 });
  const feed = window.RemyData.useFeed();
  return (
    <>
...
window.RemyPages = Object.assign(window.RemyPages || {}, { ProfilePage });
