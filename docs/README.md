...
| --- | --- | --- |
| Team page | Implemented; verification in progress | [Roster, Schedule and Manage tabs](2026-09-09-11-team-page-tabs.md). Rendering/permission checks passed; browser and visual acceptance in progress. |
...
| MoQ screens | Proposed | [Watching and broadcasting](2026-09-09-09-moq-on-shadcn.md). Shared registry frame, typed media state and a real-media browser probe. |
