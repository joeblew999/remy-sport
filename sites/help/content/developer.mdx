...
- The application's own API is separate — full reference at [https://remy.ubuntusoftware.net/api/doc](https://remy.ubuntusoftware.net/api/doc), schema at [https://remy.ubuntusoftware.net/api/openapi.json](https://remy.ubuntusoftware.net/api/openapi.json).
