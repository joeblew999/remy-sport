...
const outTypes = "src/api-client/schema.d.ts"
const outClient = "src/api-client/index.ts"
...
writeFileSync("src/api-client/openapi.json", JSON.stringify(spec, null, 2))
console.log("Saved src/api-client/openapi.json")

// 2. Generate types from the saved spec
console.log("Generating TypeScript types…")
execSync(`bun x openapi-typescript src/api-client/openapi.json -o ${outTypes}`, {
  stdio: "inherit",
})
