 ...
 *
 * `bun run ops fonts` after changing a family or a weight in styles.css, or
 * a locale in the model. The output is committed, so no build and no other
 * command ever reaches the network for a font.
 */
