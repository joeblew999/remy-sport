...
const BIZ = resolve(import.meta.dirname, "../../../remy-sport-biz/domain/model")
const HERE = resolve(import.meta.dirname, "../../src/domain/model")
const SETTINGS = resolve(import.meta.dirname, "../../project.inlang/settings.json")
