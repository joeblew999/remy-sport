...
export const PROVINCE = [
  ...
  { code: "ACR", names: {"th":"อำนาจเจริญ","en":"Amnat Charoen","ja":"アムナートチャルーン"} },
  { code: "ATG", names: {"th":"อ่างทอง","en":"Ang Thong","ja":"アーントーン"} },
  { code: "AYA", names: {"th":"พระนครศรีอยุธยา","en":"Phra Nakhon Si Ayutthaya","ja":"アユタヤ"} },
  { code: "BKN", names: {"th":"บึงกาฬ","en":"Bueng Kan","ja":"ブンカーン"} },
  { code: "BRM", names: {"th":"บุรีรัมย์","en":"Buriram","ja":"ブリーラム"} },
  { code: "CCO", names: {"th":"ฉะเชิงเทรา","en":"Chachoengsao","ja":"チャチューンサオ"} },
  { code: "CNT", names: {"th":"ชัยนาท","en":"Chai Nat","ja":"チャイナート"} },
  { code: "CPM", names: {"th":"ชัยภูมิ","en":"Chaiyaphum","ja":"チャイヤプーム"} },
  { code: "CPN", names: {"th":"ชุมพร","en":"Chumphon","ja":"チュムポーン"} },
  { code: "CTI", names: {"th":"จันทบุรี","en":"Chanthaburi","ja":"チャンタブリー"} },
  { code: "KBI", names: {"th":"กระบี่","en":"Krabi","ja":"クラビー"} },
  { code: "KPT", names: {"th":"กำแพงเพชร","en":"Kamphaeng Phet","ja":"カムペーンペット"} },
  { code: "KRI", names: {"th":"กาญจนบุรี","en":"Kanchanaburi","ja":"カーンチャナブリー"} },
  { code: "KSN", names: {"th":"กาฬสินธุ์","en":"Kalasin","ja":"カーラシン"} },
  { code: "LEI", names: {"th":"เลย","en":"Loei","ja":"ルーイ"} },
  { code: "LPG", names: {"th":"ลำปาง","en":"Lampang","ja":"ランパーン"} },
  { code: "LPN", names: {"th":"ลำพูน","en":"Lamphun","ja":"ランプーン"} },
  { code: "LRI", names: {"th":"ลพบุรี","en":"Lopburi","ja":"ロッブリー"} },
  { code: "MDH", names: {"th":"มุกดาหาร","en":"Mukdahan","ja":"ムクダーハーン"} },
  { code: "MKM", names: {"th":"มหาสารคาม","en":"Maha Sarakham","ja":"マハーサーラカーム"} },
  { code: "MSN", names: {"th":"แม่ฮ่องสอน","en":"Mae Hong Son","ja":"メーホンソーン"} },
  { code: "NAN", names: {"th":"น่าน","en":"Nan","ja":"ナーン"} },
  { code: "NBP", names: {"th":"หนองบัวลำภู","en":"Nong Bua Lamphu","ja":"ノーンブアラムプー"} },
  { code: "NKI", names: {"th":"หนองคาย","en":"Nong Khai","ja":"ノーンカーイ"} },
  { code: "NPM", names: {"th":"นครพนม","en":"Nakhon Phanom","ja":"ナコンパノム"} },
  { code: "NPT", names: {"th":"นครปฐม","en":"Nakhon Pathom","ja":"ナコンパトム"} },
  { code: "NSN", names: {"th":"นครสวรรค์","en":"Nakhon Sawan","ja":"ナコンサワン"} },
  { code: "NWT", names: {"th":"นราธิวาส","en":"Narathiwat","ja":"ナラーティワート"} },
  { code: "NYK", names: {"th":"นครนายก","en":"Nakhon Nayok","ja":"ナコンナーヨック"} },
  { code: "PBI", names: {"th":"เพชรบุรี","en":"Phetchaburi","ja":"ペッチャブリー"} },
  { code: "PCT", names: {"th":"พิจิตร","en":"Phichit","ja":"ピチット"} },
  { code: "PLG", names: {"th":"พัทลุง","en":"Phatthalung","ja":"パッタルン"} },
  { code: "PLK", names: {"th":"พิษณุโลก","en":"Phitsanulok","ja":"ピサヌローク"} },
  { code: "PNA", names: {"th":"พังงา","en":"Phang Nga","ja":"パンガー"} },
  { code: "PNB", names: {"th":"เพชรบูรณ์","en":"Phetchabun","ja":"ペッチャブーン"} },
  { code: "PRE", names: {"th":"แพร่","en":"Phrae","ja":"プレー"} },
  { code: "PRI", names: {"th":"ปราจีนบุรี","en":"Prachinburi","ja":"プラーチーンブリー"} },
  { code: "PKN", names: {"th":"ประจวบคีรีขันธ์","en":"Prachuap Khiri Khan","ja":"プラチュワップキーリーカン"} },
  { code: "PTN", names: {"th":"ปัตตานี","en":"Pattani","ja":"パッタニー"} },
  { code: "PYO", names: {"th":"พะเยา","en":"Phayao","ja":"パヤオ"} },
  { code: "RET", names: {"th":"ร้อยเอ็ด","en":"Roi Et","ja":"ローイエット"} },
  { code: "RNG", names: {"th":"ระนอง","en":"Ranong","ja":"ラノーン"} },
  { code: "RYG", names: {"th":"ระยอง","en":"Rayong","ja":"ラヨーン"} },
  { code: "SBR", names: {"th":"สิงห์บุรี","en":"Sing Buri","ja":"シンブリー"} },
  { code: "SKM", names: {"th":"สมุทรสงคราม","en":"Samut Songkhram","ja":"サムットソンクラーム"} },
  { code: "SKN", names: {"th":"สมุทรสาคร","en":"Samut Sakhon","ja":"サムットサーコーン"} },
  { code: "SKW", names: {"th":"สระแก้ว","en":"Sa Kaeo","ja":"サケーオ"} },
  { code: "SNK", names: {"th":"สกลนคร","en":"Sakon Nakhon","ja":"サコンナコン"} },
  { code: "SPB", names: {"th":"สุพรรณบุรี","en":"Suphan Buri","ja":"スパンブリー"} },
  { code: "SPK", names: {"th":"สมุทรปราการ","en":"Samut Prakan","ja":"サムットプラーカーン"} },
  { code: "SRI", names: {"th":"สระบุรี","en":"Saraburi","ja":"サラブリー"} },
  { code: "SRN", names: {"th":"สุรินทร์","en":"Surin","ja":"スリン"} },
  { code: "SSK", names: {"th":"ศรีสะเกษ","en":"Sisaket","ja":"シーサケート"} },
  { code: "STI", names: {"th":"สุโขทัย","en":"Sukhothai","ja":"スコータイ"} },
  { code: "STN", names: {"th":"สตูล","en":"Satun","ja":"サトゥーン"} },
  { code: "TAK", names: {"th":"ตาก","en":"Tak","ja":"ターク"} },
  { code: "TRG", names: {"th":"ตรัง","en":"Trang","ja":"トラン"} },
  { code: "TRT", names: {"th":"ตราด","en":"Trat","ja":"トラート"} },
  { code: "UTI", names: {"th":"อุทัยธานี","en":"Uthai Thani","ja":"ウタイターニー"} },
  { code: "UTT", names: {"th":"อุตรดิตถ์","en":"Uttaradit","ja":"ウッタラディット"} },
  { code: "YLA", names: {"th":"ยะลา","en":"Yala","ja":"ヤラー"} },
  { code: "YST", names: {"th":"ยโสธร","en":"Yasothon","ja":"ヤソートーン"} },
] as const
...
export const RELATION = [
  { code: "OWNER", objectTypeCode: "EVENT", via: "table", sourceTable: "events", objectColumn: "id", userColumn: "organizer_user_id", filterColumn: null, filterValue: null, throughTable: null, throughColumn: null, activeFromColumn: null, activeToColumn: null, roleCode: null, parentRelation: null, names: {"th":"เจ้าของ","en":"Owner","ja":"オーナー"} },
  ...
  { code: "TEAM_PLAYER", objectTypeCode: "TEAM", via: "table", sourceTable: "player_teams", objectColumn: "team_id", userColumn: "user_id", filterColumn: null, filterValue: null, throughTable: "players", throughColumn: "player_id", activeFromColumn: "from_date", activeToColumn: "to_date", roleCode: null, parentRelation: null, names: {"th":"ผู้เล่นในทีม","en":"Team Player","ja":"チーム所属選手"} },
  { code: "SELF", objectTypeCode: "PLAYER", via: "table", sourceTable: "players", objectColumn: "id", userColumn: "user_id", filterColumn: null, filterValue: null, throughTable: null, throughColumn: null, activeFromColumn: null, activeToColumn: null, roleCode: null, parentRelation: null, names: {"th":"ตัวเอง","en":"Self","ja":"本人"} },
  { code: "GUARDIAN", objectTypeCode: "PLAYER", via: "table", sourceTable: "guardians", objectColumn: "player_id", userColumn: "user_id", filterColumn: null, filterValue: null, throughTable: null, throughColumn: null, activeFromColumn: null, activeToColumn: null, roleCode: null, parentRelation: null, names: {"th":"ผู้ปกครอง","en":"Guardian","ja":"保護者"} },
  ...
  { code: "PLATFORM_ADMIN", objectTypeCode: "PLATFORM", via: "role", sourceTable: null, objectColumn: null, userColumn: null, filterColumn: null, filterValue: null, throughTable: null, throughColumn: null, activeFromColumn: null, activeToColumn: null, roleCode: "ADMIN", parentRelation: null, names: {"th":"ผู้ดูแลแพลตฟอร์ม","en":"Platform Admin","ja":"プラットフォーム管理者"} },
  { code: "ANY_ORGANIZER", objectTypeCode: "PLATFORM", via: "role", sourceTable: null, objectColumn: null, userColumn: null, filterColumn: null, filterValue: null, throughTable: null, throughColumn: null, activeFromColumn: null, activeToColumn: null, roleCode: "ORGANIZER", parentRelation: null, names: {"th":"ผู้จัดการแข่งขันใดๆ","en":"Any Organizer","ja":"主催者全員"} },
  { code: "ANY_COACH", objectTypeCode: "PLATFORM", via: "role", sourceTable: null, objectColumn: null, userColumn: null, filterColumn: null, filterValue: null, throughTable: null, throughColumn: null, activeFromColumn: null, activeToColumn: null, roleCode: "COACH", parentRelation: null, names: {"th":"โค้ชใดๆ","en":"Any Coach","ja":"コーチ全員"} },
  { code: "ANY_PLAYER", objectTypeCode: "PLATFORM", via: "role", sourceTable: null, objectColumn: null, userColumn: null, filterColumn: null, filterValue: null, throughTable: null, throughColumn: null, activeFromColumn: null, activeToColumn: null, roleCode: "PLAYER", parentRelation: null, names: {"th":"ผู้เล่นใดๆ","en":"Any Player","ja":"選手全員"} },
  { code: "ANY_REFEREE", objectTypeCode: "PLATFORM", via: "role", sourceTable: null, objectColumn: null, userColumn: null, filterColumn: null, filterValue: null, throughTable: null, throughColumn: null, activeFromColumn: null, activeToColumn: null, roleCode: "REFEREE", parentRelation: null, names: {"th":"ผู้ตัดสินใดๆ","en":"Any Referee","ja":"審判全員"} },
  { code: "ANY_SPECTATOR", objectTypeCode: "PLATFORM", via: "role", sourceTable: null, objectColumn: null, userColumn: null, filterColumn: null, filterValue: null, throughTable: null, throughColumn: null, activeFromColumn: null, activeToColumn: null, roleCode: "SPECTATOR", parentRelation: null, names: {"th":"ผู้ชมใดๆ","en":"Any Spectator","ja":"観戦者全員"} },
  { code: "ANY_SIGNED_IN", objectTypeCode: "PLATFORM", via: "everyone", sourceTable: null, objectColumn: null, userColumn: null, filterColumn: null, filterValue: null, throughTable: null, throughColumn: null, activeFromColumn: null, activeToColumn: null, roleCode: null, parentRelation: null, names: {"th":"ผู้ที่เข้าสู่ระบบใดๆ","en":"Any Signed-in User","ja":"ログイン中の全ユーザー"} },
  { code: "PUBLIC", objectTypeCode: "PLATFORM", via: "everyone", sourceTable: null, objectColumn: null, userColumn: null, filterColumn: null, filterValue: null, throughTable: null, throughColumn: null, activeFromColumn: null, activeToColumn: null, roleCode: null, parentRelation: null, names: {"th":"สาธารณะ","en":"Public","ja":"一般公開"} },
