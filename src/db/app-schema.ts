 ...
 *
 * Now they are tables with foreign keys, and `bun run test:e2e` asserts the API
 ...
 * `bun scripts/ops/auth-schema.ts --write` and must not be edited by hand. Keeping the
 ...
 * `tests/repo/domain-coverage.test.ts`.
 */
