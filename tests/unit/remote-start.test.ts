...
const f = vi.hoisted(() => ({
  ...
  calls: [] as string[], failLogin: false,
}))
...
beforeEach(() => {
  Object.assign(f, { app: true, editor: true, loggedIn: true, connector: true, publicMatches: true, raceApp: false, calls: [], failLogin: false })
