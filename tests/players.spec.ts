...
import { ADMIN, COACH, PLAYER, signIn, actorsCan, actorsCannot } from "./helpers"

const CREATORS   = actorsCan("player", "create")
const NO_CREATE  = actorsCannot("player", "create")
const NO_UPDATE  = actorsCannot("player", "update")
