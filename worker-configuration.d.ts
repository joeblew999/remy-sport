/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0b1583082516747d8fe1e47633a896b8)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "EMAIL_FROM" | "BETTER_AUTH_SECRET" | "MAIL_TRANSPORT" | "TEST_OTP" | "TUNNEL_HOSTNAME" | "VAPID_SUBJECT" | "VAPID_PUBLIC_KEY" | "VAPID_PRIVATE_KEY" | "BETTER_AUTH_URL" | "ENVIRONMENT">> {}
}
declare module "*.sql" {
	const value: string;
