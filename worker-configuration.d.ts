/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6cc2eea0c695490c9a873f507a9cbe27)
// Runtime types generated with workerd@1.20260820.1 2025-09-01 nodejs_compat,unhandled_rejection_after_microtask_checkpoint
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "EMAIL_FROM" | "NOTIFY_EMAIL_FROM" | "BETTER_AUTH_SECRET" | "MAIL_TRANSPORT" | "TEST_OTP" | "TUNNEL_HOSTNAME" | "VAPID_SUBJECT" | "VAPID_PUBLIC_KEY" | "VAPID_PRIVATE_KEY" | "BETTER_AUTH_URL" | "ENVIRONMENT">> {}
}
declare module "*.sql" {
	const value: string;
