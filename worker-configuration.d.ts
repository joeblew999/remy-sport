/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=scripts/lib/types.env` (hash: d7110b56c4fdc5f0a03498803db6eea8)
// Runtime types generated with workerd@1.20260903.1 2025-09-01 nodejs_compat,unhandled_rejection_after_microtask_checkpoint
interface __BaseEnv_Env {
	...
	NOTIFICATIONS: Queue;
	ASSETS: Fetcher;
	BETTER_AUTH_URL: "https://staging-remy.ubuntusoftware.net" | "https://remy.ubuntusoftware.net";
	MAIL_TRANSPORT: "cloudflare";
	ENVIRONMENT: "staging" | "production";
	BUILD: {"commit":"dev","branch":"dev","builtAt":"1970-01-01T00:00:00.000Z","environment":"staging","app":"0.0.0","github":""} | {"commit":"dev","branch":"dev","builtAt":"1970-01-01T00:00:00.000Z","environment":"dev","app":"0.0.0","github":""};
	EMAIL_FROM: "noreply@staging.remy.ubuntusoftware.net" | "noreply@remy.ubuntusoftware.net";
	NOTIFY_EMAIL_FROM?: "notifications@staging.remy.ubuntusoftware.net";
}
declare namespace Cloudflare {
	...
	interface StagingEnv {
		...
		NOTIFICATIONS: Queue;
		ASSETS: Fetcher;
		BETTER_AUTH_URL: "https://staging-remy.ubuntusoftware.net";
		MAIL_TRANSPORT: "cloudflare";
		ENVIRONMENT: "staging";
		BUILD: {"commit":"dev","branch":"dev","builtAt":"1970-01-01T00:00:00.000Z","environment":"staging","app":"0.0.0","github":""};
		EMAIL_FROM: "noreply@staging.remy.ubuntusoftware.net";
		NOTIFY_EMAIL_FROM: "notifications@staging.remy.ubuntusoftware.net";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_URL" | "MAIL_TRANSPORT" | "ENVIRONMENT" | "BUILD" | "EMAIL_FROM" | "NOTIFY_EMAIL_FROM">> {}
}
