/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: df366a4e0a774285631e550571fea3d8)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_URL" | "EMAIL_FROM" | "BETTER_AUTH_SECRET" | "MAIL_TRANSPORT" | "TEST_OTP">> {}
}
declare module "*.sql" {
	const value: string;
