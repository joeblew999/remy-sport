/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: cd030f2ae149de75d1ff52326d3ce93f)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_URL" | "EMAIL_FROM" | "BETTER_AUTH_SECRET" | "MAIL_TRANSPORT" | "TEST_OTP" | "TUNNEL_HOSTNAME">> {}
}
declare module "*.sql" {
	const value: string;
